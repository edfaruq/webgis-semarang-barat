...
export default async function middleware(req: NextRequest) {
  ...
  // Only protect /internal/* routes (admin)
  ...
  // On sign-in page: if already authenticated admin, redirect to console
  if (isSignIn) {
  ...
  // All other /internal/* routes: require authenticated admin
  if (!session) {
